...
if [[ -d $crop_dir ]]; then
	...
	paste $author_dir/positive.index $author_dir/positive.Seq.txt $author_dir/positive.Ann.txt $author_dir/positive.fimo.txt > $author_dir/positive.features.txt
#	rm  $author_dir/positive.index $author_dir/positive.Ann.txt $author_dir/positive.fimo.txt $author_dir/positive.Seq.txt
        ...
        paste $author_dir/negative.index $author_dir/negative.Seq.txt $author_dir/negative.Ann.txt $author_dir/negative.fimo.txt > $author_dir/negative.features.txt
